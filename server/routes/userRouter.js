...
const { signUp, logIn, logOut, getAllProducts, getUserDetails, getProductDetailsByid } = require("../controller/user-contoller");
...
userRouter.get("/getproductdetails/:id", getProductDetailsByid)
